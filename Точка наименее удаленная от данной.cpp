...
int main()
{
	...
	double min;
	cout << "vvedi koordinaty ishodnoy tochki\n";
	cin >> x;
	cin >> y;
	cin >> z;
	cout << "vvedi koordinaty pervoy tochki\n";
	cin >> x1;
	cin >> y1;
	cin >> z1;
	cout << "vvedi koordinaty vtoroy tochki\n";
	cin >> x2;
	cin >> y2;
	cin >> z2;
	cout << "vvedi koordinaty tretiey tochki\n";
	cin >> x3;
	cin >> y3;
	cin >> z3;
	cout << "vvedi koordinaty chetvertoy tochki\n";
	cin >> x4;
	cin >> y4;
	cin >> z4;
	cout << "vvedi koordinaty pyatoy tochki\n";
	cin >> x5;
	cin >> y5;
	cin >> z5;
